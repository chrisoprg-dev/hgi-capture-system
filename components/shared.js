...
const HGI_CONTEXT = "HGI Global / Hammerman and Gainer LLC — 95-year-old 100% minority-owned government services firm. Kenner LA (HQ), Shreveport, Alexandria, New Orleans. ~67 FT + 43 contract staff. Leadership: Christopher J. Oney (President), Larry D. Oney (Chairman), Louis J. Resweber (CEO), Candy L. Dottolo (CAO), Vanessa R. James (SVP Claims), S. Adaan Uzzaman (CSO). 8 verticals: (1) Disaster Recovery/CDBG-DR/FEMA PA/HMGP, (2) TPA/Claims — full P and C incl workers comp/property/liability/guaranty, (3) Property Tax Appeals, (4) Workforce Services/WIOA, (5) Construction Management, (6) Program Administration — federal/state NOT healthcare, (7) Housing/HUD, (8) Grant Management. Key past performance: Road Home Program $12B zero misappropriation, BP GCCF 1M+ claims for Kenneth Feinberg, TPCIGA 28yrs TX workers comp TPA, PBGC 5+yrs 50 staff 34M beneficiaries, City of New Orleans workers comp $283K/mo, SWBNO billing appeals $200K/mo, Orleans Parish School Board 22yrs, Terrebonne Parish School Board construction mgmt, Restore Louisiana, Jefferson Parish FEMA PA. Insurance: $5M fidelity bond, $5M E and O, $2M GL ($1M occ/$2M agg). SAM UEI: DL4SJEVKZ6H4. NAICS: 541611, 541690, 561110, 561990, 524291, 923120, 921190. PRICING: Do NOT use a fixed rate card. Always build pricing from the specific RFP required positions. Reference HTHA 2026 rates in KB as one data point for comparable DR work only.";
