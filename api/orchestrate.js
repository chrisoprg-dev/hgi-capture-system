...
export default async function handler(req, res) {
  ...
  try {
    scopeAnalysis = await claudeCall(
      ...
      'You are a senior government contracting scope analyst. CRITICAL: Your first job is to determine the EXACT type of work being requested and whether it matches HGI capabilities.\n\n' + HGI_CLASSIFICATION_GUIDE + '\n\nBe exhaustive. When RFP text is thin, use knowledge of similar contracts to determine what type of work this actually is. Geography: LA, TX, FL, MS, AL, GA — never confuse same-named entities across states.', 2500
    );
