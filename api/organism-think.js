...
export default async function handler(req, res) {
  ...
  const prompt =
    ...
    'HGI: 96yr minority-owned program management, TPA, claims, professional services firm. Business lines: Disaster Recovery, TPA/Claims, Property Tax Appeals, Workforce/WIOA, Construction Mgmt, Program Admin, Housing/HUD, Grant Mgmt, Mediation Services, Class Action/Settlement Admin, Staff Augmentation, Call Centers, DEI Consulting, Self-Insured Claims, Risk Management. NEVER a direct federal contract. Past performance: Road Home $67M/$13B+ zero misappropriation, Restore LA $42.3M, BP GCCF $1.65M 1M+ claims, TPCIGA 20+ yrs TX, PBGC 34M beneficiaries, City of NOLA WC TPA active, SWBNO billing appeals active, TPSD $2.96M completed 2022-2025. Geography: LA TX FL MS AL GA.\n\n' +
