...
async function claudeReact(agentConfig, eventType, action, opportunity, storeData, extraPayload) {
  ...
  prompt += 'Respond in JSON only. No markdown backticks. No preamble.\n{\n  "analysis": "Your reasoning. What you concluded and why. Be specific, cite data, make cross-opportunity connections. 3-8 sentences.",\n  "store_updates": [\n    { "store": "competitive_intelligence OR relationship_graph OR system_performance_log", "data": { "key fields relevant to this store" } }\n  ],\n  "downstream_insights": "What other agents should know. 1-3 sentences."\n}';
